 ...
 * Timing uses the 1 ms SysTick (HAL_GetTick); output uses printf over the VCP.
...
#define HAS_PRINTF  1   /* maps ee_printf -> printf (retargeted to VCP)    */
...
#endif
#ifndef FLAGS_STR
#define FLAGS_STR "-O3 -mcpu=cortex-m7 -mfpu=fpv5-sp-d16 -mfloat-abi=hard"
#endif
