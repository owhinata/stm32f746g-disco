...
# mirroring what the old Makefile did. Toolchain files are processed before the
# compiler check, so the download must happen here.

set(CMAKE_SYSTEM_NAME      Generic)
set(CMAKE_SYSTEM_PROCESSOR arm)

# --- Auto-download the ARM GNU toolchain -----------------------------------
set(TC_VERSION  "13.3.rel1")
...
if(NOT EXISTS "${GCC_BIN}/arm-none-eabi-gcc")
    message(STATUS "Downloading ARM GNU toolchain ${TC_VERSION} (~150 MB) ...")
